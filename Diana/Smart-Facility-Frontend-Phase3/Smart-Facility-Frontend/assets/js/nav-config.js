  ...
  operations_manager: {
    ...
    nav: [
      ...
      { title: 'الصيانة', items: [
        ...
        ['أوامر العمل', '../operations-manager/work-orders.html', 'operations-work-orders', 'work_orders'],
      ]},
      { title: 'الأعطال والتقارير', items: [
  ...
  security_officer: {
    ...
    nav: [
      ...
      { title: 'المراقبة والتنبيه', items: [
        ['التنبيهات الأمنية', '../security-officer/alerts.html', 'security-alerts', 'security_alert'],
      ...
      { title: 'الحوادث والاستجابة', items: [
        ...
        ['إجراءات الاستجابة', '../security-officer/response-management.html', 'security-response', 'response'],
        ['سجل الأحداث الأمنية', '../security-officer/event-logs.html', 'security-events', 'event_log'],
      ]},
